...
('Entre 1 y 2 horas ',3,1),
('No ',3,1),
('Tutoriales o crash courses ',3,1),
('Videos ',3,1),
('Muy poco',2,1),
...
('Twitter',3,1),
('Clarovideo',3,1),
('Entre 3 y 4 horas ',3,1),
('Nintendo ',3,1),
('Chegg',3,1),
('E-mail',3,1),
('Entre 3 y 4 horas ',3,1),
('Revistas científicas o similares ',3,1),
...
('Plataformas educativas ',3,1),
('Tiktok',3,1),
('Blim ',3,1),
('Más de 4 horas ',3,1),
('PlayStaion',3,1),
('Otro (especifique)',3,1),
('Aplicaciones',3,1),
('Más de 4 horas ',3,1),
('Una página de un profesionista influyente en tu área',3,1),
